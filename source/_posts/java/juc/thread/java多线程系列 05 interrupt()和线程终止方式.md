---
title: Java多线程系列05interrupt()和线程终止方式
tags:
  - 并发
categories:
  - java
...
解决该问题，需要我们在捕获异常时，额外的进行退出while循环的处理。例如，在MyThread的catch(InterruptedException)中添加break或return就能解决该问题。
